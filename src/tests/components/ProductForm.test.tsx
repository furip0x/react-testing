...
describe("ProductForm", () => {
  ...
  it.each([
    ...
    "should display an $errorMessage if name is $scenario",
  ...
  it.each([
    ...
    {
      scenario: "can't be less than 0",
      price: -1,
      errorMessage: /1/i,
    },
    {
      scenario: "can't be equal to 0",
      price: 0,
      errorMessage: /1/i,
    },
    {
      scenario: "can't be greater than 1000",
      price: 1001,
      errorMessage: /1000/i,
    },
    {
    ...
    "should display an $errorMessage if price is $scenario",
